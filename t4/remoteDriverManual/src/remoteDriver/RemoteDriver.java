...
public class RemoteDriver {
	...
	static String fileName = "trucker.fcl";
    ...
    public static void main(String[] args) throws IOException {
        ...
        while ((fromServer = in.readLine()) != null) {
			...
			fis.setVariable("positionX", x);
			fis.setVariable("positionY", y);
			fis.setVariable("angle", angle);
			fis.evaluate();
			double respostaDaSuaLogica = Double.valueOf(fis.getVariable("steering").defuzzify()); // atribuir um valor entre -1 e 1 para virar o volante pra esquerda ou direita.
